...
_lr_productions = [
  ...
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',140),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',144),
  ('items -> item items','items',2,'p_items','yacc.py',148),
  ('items -> empty','items',1,'p_items_empty','yacc.py',152),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',156),
  ('item -> atom','item',1,'p_item_atom','yacc.py',160),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',168),
  ('item -> call','item',1,'p_item_call','yacc.py',172),
  ('item -> empty','item',1,'p_item_empty','yacc.py',176),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',180),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',185),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',189),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',193),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',197),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',201),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',205),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',209),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',213),
]
